...
Feature: As a user,
  ...
  Scenario: User should log the contact us form
    ...
    And I enter "Dhara" name to name field
    And I enter "tester@gmail.com" email to email field
  ...
  Scenario: User should subscribe in the homepage
    ...
    Then I enter email "tester@gmail.com"
  ...
  Scenario: User should download invoice after purchase order
    ...
    And I enter payment details "Mahendra Patel" "4263982640269299" "837" "02" and "2026"
